...
Note the instructions regarding the virtual environment for running offline where only relevant for Coffea07 and are not needed in Coffea2026 and can be ignored. 
They will be deleted in a future commit.
